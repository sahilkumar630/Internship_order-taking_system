...
export class LocationComponent implements OnInit {
    ...
    this.locationService
      ...
      .catch(
        (error: Error) => {
          ...
          // -------------------------------------
          // Automatically show manual option
          // -------------------------------------
  ...
  saveManualLocation(): void {
    ...
    // IMPORTANT
    //
    // At this stage we don't have GPS
    // coordinates for the manually selected
    // area.
    //
    // Therefore we use predefined coordinates
    // for the currently supported areas.
    // -----------------------------------------
  ...
  // =========================================
  //
  // These are temporary coordinates for
